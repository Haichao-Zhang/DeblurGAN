...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--lambda_B', type=float, default=10.0, help='weight for cycle loss (B -> A -> B)')
                self.parser.add_argument('--lambda_C', type=float, default=100000.0, help='weight for reblur loss')
                self.parser.add_argument('--lambda_K', type=float, default=100.0, help='weight for psf loss')
